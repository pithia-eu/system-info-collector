...
def get_items_to_collect():
    ...
    items_to_collect_list = [{"name": {"enabled": collect_hostname_bool, "function": collect_hostname}},
                             {"uptime": {"enabled": collect_uptime_bool, "function": collect_uptime}},
                             {"date": {"enabled": collect_date_bool, "function": collect_date}},
                             {"os": {"enabled": collect_os_bool, "function": collect_os}},
                             {"kernel": {"enabled": collect_kernel_bool, "function": collect_kernel}},
                             {"disks": {"enabled": collect_os_disk_bool, "function": collect_os_disk}},
                             {"ip": {"enabled": collect_ip_bool, "function": collect_ip}},
                             {"firewall": {"enabled": collect_firewall_bool, "function": collect_firewall}},
                             {"ports": {"enabled": collect_ports_bool, "function": collect_ports}},
                             {"users": {"enabled": collect_users_bool, "function": collect_users}},
                             {"groups": {"enabled": collect_groups_bool, "function": collect_groups}},
                             {"services": {"enabled": collect_services_bool, "function": collect_services}},
                             {"processes": {"enabled": collect_processes_bool, "function": collect_processes}},
                             {"scheduled_tasks": {"enabled": collect_scheduled_tasks_bool, "function": collect_scheduled_tasks}},
                             {"packages": {"enabled": collect_packages_bool, "function": collect_packages}},
